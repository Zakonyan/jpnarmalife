...
/* Database Related Settings */
    ...
    saved_virtualItems[] = { "pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","henRaw","rooster","roosterRaw","sheep","sheepRaw","goat","goatRaw","defibrillator","toolkit","handcuff","rabbitRaw","rabbit" }; //Array of virtual items that can be saved on your player.
...
/* System Settings */
    ...
    jail_seize_vItems[] = { "spikeStrip","lockpick","goldbar","blastingcharge","boltcutter","defusekit","heroin_unprocessed","heroin_processed","cannabis","marijuana","cocaine_unprocessed","cocaine_processed","turtle_raw","handcuff" }; //Define VIRTUAL items you want to be removed from players upon jailing here. Use "jail_seize_inventory" for Arma inventory items.
    ...
    paycheck_civ = 100; //Payment for civillians
    paycheck_med = 250; //Payment for medics
