...
if(_varName == LICENSE_VARNAME("rebel",_sideFlag)) then { missionNamespace setVariable [LICENSE_VARNAME("bounty","civ"),false] };
if(_varName == LICENSE_VARNAME("gun",_sideFlag)) then { missionNamespace setVariable [LICENSE_VARNAME("bounty","civ"),false] };
